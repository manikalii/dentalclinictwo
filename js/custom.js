// if (location.host == "oscarthemes.com") {
/* 
...
$(document).ready(function() {
    ...
    */
    ...
    if ($('.scroll-btn,.get-start').length) {
        ...
        $('.scroll-btn,.get-start').click(function(e) {
        ...
        gmMapDiv.gmap3({
            ...
            map: {
                ...
                options: {
                    ...
                    /* hide/show (false/true) mapTypeControl*/

                    scaleControl: false,
                    /*hide/show (false/true) scaleControl */

                    scrollwheel: false,
                    /*hide/show (false/true) scrollwheel*/

                    streetViewControl: gmstreetViewControl,
                    /*hide/show (false/true) streetViewControl*/
...
// } else {
//     location.href = "http://oscarthemes.com";
// }